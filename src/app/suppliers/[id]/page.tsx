        ...
        if (response.ok) {
          ...
          if (data.length > 0) {
            ...
            setFormData({
              ...
              category: supplier.category || "sembako",
  ...
  if (fetching) {
    return (
      <div className="flex items-center justify-center h-64">
        <div className="text-gray-600">Memuat data supplier...</div>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-3xl">
      <div className="mb-6">
        ...
        <p className="text-gray-600 mt-1">Perbarui informasi supplier</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 space-y-6">
        ...
        <div className="flex gap-4 pt-4 border-t border-gray-200">
          ...
          >
            {loading ? "Menyimpan..." : "Perbarui Supplier"}
          </button>
          <button
            type="button"
            onClick={() => router.back()}
